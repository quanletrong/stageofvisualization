<div style="position: fixed; right:0; width: 100%;bottom: 0px; max-width:600px; display: none; z-index: 4;" id="box_trao_doi_noi_bo">
...
<script>
    ...
    function onbefore_upload_add_file_attach_chat_noi_bo(eventDrop, dropTo) {
        ...
        >
            <div class="position-btn" style="position: absolute; display: none; top: 0; right:0">
                <button class="btn btn-sm btn-warning rounded-circle" onclick="remove_chat_noi_bo_attach('#file_attach_${dropTo}')">
                    <i class="fas fa-trash"></i>
                </button>
            </div>
    ...
    function onprogress_upload_add_file_attach_chat_noi_bo(eventDrop, percent, dropTo) {
        $(`#file_attach_${dropTo} .percent`).text(`${percent} %`);
    }

    function onerror_upload_add_file_attach_chat_noi_bo(eventDrop, error, error_text, dropTo) {
        $(`#file_attach_${dropTo} .percent`).text(`Error`);
        alert(error_text);
    }

    function onsuccess_upload_add_file_attach_chat_noi_bo(eventDrop, success, dropTo) {
