...
<div class="row">
    ...
    <div class="col-lg-2 col-6">
        <div class="info-box">
            <div class="info-box-content">
                <span class="info-box-text">TOTAL IMAGE QC CHECK</span>
                <span class="info-box-number"><?= isset($box['image_qc_check']) ? $box['image_qc_check'] : 0 ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-6">
        <div class="info-box">
            <div class="info-box-content">
                <span class="info-box-text">TOTAL IMAGE PENDING</span>
                <span class="info-box-number"><?= isset($box['image_pending']) ? $box['image_pending'] : 0 ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-6">
        <div class="info-box">
            <div class="info-box-content">
                <span class="info-box-text">TOTAL IMAGE DONE</span>
                <span class="info-box-number"><?= isset($box['image_done']) ? $box['image_done'] : 0 ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-6">
        <div class="info-box">
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?= isset($box['image_all']) ? $box['image_all'] : 0 ?></span>
            </div>
        </div>
    </div>
</div>
