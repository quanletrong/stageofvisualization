<?php ?>
<style>
    #privacy_policy_pre img,
    #privacy_policy_pre iframe,
    #privacy_policy_pre table {
        width: 100% !important;
    }
</style>
        ...
        <div class="container-fluid">
            <div class="card card-info">
                ...
                <div class="card-body p-3">
                    ...
                    <form method="post" action="setting/privacy_policy">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <textarea id="privacy_policy" name="privacy_policy"><?= html_entity_decode(htmlspecialchars_decode($setting['privacy_policy'])) ?></textarea>

                            </div>

                            <div class="col-md-6">
                                <span class="text-bold">Xem trước</span>
                                <div id="privacy_policy_pre" class="border p-2"><?= html_entity_decode(htmlspecialchars_decode($setting['privacy_policy'])) ?></div>
                            </div>
                        </div>
                        <div style="display: flex; justify-content: flex-start;">
                            <button type="submit" class="btn btn-sm btn-danger m-1">Lưu lại</button>
        ...
        tinymce.init({
            ...
            setup: function(ed) {
                ed.on('change', function(e) {
                    $('#privacy_policy').val(ed.getContent())
                    $('#privacy_policy_pre').html(ed.getContent())
                });
            }
        });
    })
